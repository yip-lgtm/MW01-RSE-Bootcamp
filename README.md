...
- 完成 4 個核心項目後頒發 結業證書，之後可繼續進階其他項目（1.17、1.50 等）
...
|----------|---------------------------------------|----------|---------------------------------------|------------|
| 1.6 | Alteration or Removal of Protective Barrier | ✅ 完成 | MW1.6_Protective_Barrier_Final.pdf | - |
| 1.1 | Erection or Alteration of Internal Staircase | ⏳ 待做 | - | - |
| 1.5 | Removal of Supporting Structure on Cantilevered Slab | ⏳ 待做 | - | - |
| 1.27 | Erection / Alteration / Removal of Canopy | ⏳ 待做 | - | - |
| 1.50 | Supporting structures for AC unit on roof | ✅ 完成 | MW1.50_CS222_CS223_Final.pdf | - |
